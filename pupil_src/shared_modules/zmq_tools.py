...
if __name__ == '__main__':
    ...
    while i<10:
        ...
        #topic2, msg2 = gaze_monitor.recv()
        #print topic,msg['__raw_data__']
        print topic,msg
        #print topic2,msg2
        print i
        img = np.asarray(memoryview(np.asarray(msg['__raw_data__'][0]).data))
        #f = open("/home/ahmed/Desktop/frame" + str(i) + ".jpg", 'w')
        #f.write(img)
        #f.close()
        msg2 = cv2.imdecode(img,cv2.CV_LOAD_IMAGE_COLOR)
        #try:
            #cv2.imshow('image', msg2)
            #cv2.waitKey(20)
        cv2.imwrite("/home/ahmed/Desktop/frameCV" + str(i) + ".jpg", msg2)
        ...
        #img = msg.get(1)
        #save_object(img,"/home/ahmed/Desktop/frame" + str(i))
        #cv2.imwrite("/home/ahmed/Desktop/frame" + str(i), img)
